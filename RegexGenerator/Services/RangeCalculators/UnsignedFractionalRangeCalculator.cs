...
/// </summary>
internal class UnsignedFractionalRangeCalculator<TFractional>(RegexGeneratorOptions options) : IRangeCalculator<UnsignedFractional, UnsignedFractional>
{
    public IEnumerable<Range<UnsignedFractional<TFractional>> CalculateRegexRanges<TNumberSystem>(UnsignedFractional min, UnsignedFractional max)
    {
        if (min.Value == 0)
        {
